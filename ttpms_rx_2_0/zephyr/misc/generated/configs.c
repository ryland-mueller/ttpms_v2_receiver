...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_MICROCHIP_MCP2515_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MAX_CONN, 9);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_TTPMS_RX_2_0, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_MCP2515, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_MCP2515_INT_THREAD_STACK_SIZE, 512);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_MCP2515_INT_THREAD_PRIO, 2);
